    ...
    [9535], {
        58371: (e, t, n) => {
            ...
            var s = n(744),
                ...
                p = n(17255),
                u = n(7606);
            const h = p.ZP.div.withConfig({
                componentId: "sc-1q9fwvy-0"
            })(["position:absolute;left:0px;display:flex;align-items:center;justify-content:center;height:100%;width:100%;transition:top ", "s ", ";", ""], .5, u.dF, (e => "entering" === e.state || "entered" === e.state ? (0, p.iv)(["top:0;"]) : (0, p.iv)(["top:", ";"], e.hiddenPosition)));
            var m = n(55786);
            const f = e => {
                let {
                    isVisible: t,
            ...
            const k = w;
            var y = n(77058);
            const C = p.ZP.div.withConfig({
                    componentId: "sc-1w3tvxe-0"
                })(["width:", ";height:", ";border-radius:", ";box-shadow:rgb(36,36,36,0.15) 0px 20px 30px 0px;display:flex;align-items:center;justify-content:center;background-color:", " !important;"], (e => e.size ? ? "100%"), (e => e.size ? ? "100%"), (e => S(e.shape, e.shapeSettings)), (e => e.theme.messenger.colors.primary)),
                j = (0, p.ZP)(y.hU).withConfig({
                    componentId: "sc-1w3tvxe-1"
                })(["&&&{position:relative;overflow:hidden;border-radius:", ";width:100%;height:100%;background-color:", ";&:active{box-shadow:none;}&:focus{box-shadow:none;}&[data-garden-focus-visible]{box-shadow:inset ", ";}}"], (e => S(e.shape, e.shapeSettings)), (e => e.theme.messenger.colors.primary), (e => e.theme.shadows.md(e.theme.messenger.colors.primaryText))),
                S = (e, t) => {
                    switch (e) {
                        case l._c.circle:
                            return l.UW.circle;
                ...
                A = e => {
                    ...
                    const n = (0, r.v9)(R.FB),
                        ...
                        y = (0, i.useCallback)((() => {
                            ...
                            return g === B.uN.successful && (e = 0 === x ? b("embeddable_framework.messenger.launcher.frame.no_new_messages_title") : 1 === x ? b("embeddable_framework.messenger.launcher.frame.one_new_message_title") : b("embeddable_framework.messenger.launcher.frame.new_messages_title", {
                                count: x
                            })), e
                        }), [g, x]);
                    let C = [];
                    return d && C.push(`${q} 0.2s ease-in ${W.e}s forwards`), n && E && C.push(`${X} ${l.Aq}s ${_.dF}`), (0, m.jsxs)(m.Fragment, {
            ...
            const G = A,
                Q = () => {
                    ...
                    }), []), (0, i.useEffect)((() => ((0, $.ui)("refLauncher", l), L.I(l.current), () => {
                        L.O(l.current)
                    })), [l]), o ? (0, m.jsx)(G, {
                        children: (0, m.jsx)(O, {
                            ref: l,
            ...
            const pe = () => {
                ...
                n && (o.current = !0), (0, i.useLayoutEffect)((() => {
                ...
                return h ? (0, m.jsx)(se.Z, {
                    children: (0, m.jsxs)(re.Z, {
                        children: [(0, m.jsx)(ie.Z, {
                            title: u("embeddable_framework.messenger.launcher_label.close_v2"),
                            ref: e => f.current.closeFrame = e,
                            children: (0, m.jsx)(J.Z, {
                                ariaLabel: u("embeddable_framework.messenger.launcher_label.close_v2"),
                                onClick: () => {
                                    g((() => {
                                        e((0, ne.rh)())
                                    }))
                            ...
                            title: u("embeddable_framework.messenger.launcher_label.frame.title"),
                            maxWidth: b,
                            messageFrameWidth: w,
                            messageFrameHeight: E,
            ...
            const he = (0, i.lazy)((() => n.e(3290).then(n.bind(n, 83290)))),
                me = () => {
                    const [e, t] = (0, i.useState)(!1), n = (0, r.v9)(ue.u5);
                    return (0, i.useEffect)((() => {
                        n && t(!0)
            ...
            const xe = () => {
                ...
                ge = e => {
                    ...
                    s.render((0, m.jsxs)(r.zt, {
                        store: t,
                        children: [(0, m.jsx)(me, {}), (0, m.jsx)(pe, {}), (0, m.jsx)(Q, {}), (0, m.jsx)(xe, {})]
                    }), n, i)
                }
        },
        65611: (e, t, n) => {
        ...
        14824: (e, t, n) => {
            ...
            var d = "unmounted",
                ...
                m = function(e) {
                    function t(t, n) {
                        ...
                        return s.appearStatus = null, t.in ? i ? (r = c, s.appearStatus = p) : r = u : r = t.unmountOnExit || t.mountOnEnter ? d : c, s.state = {
                            status: r
                    ...
                    return n.componentDidMount = function() {
                        ...
                        if (e !== this.props) {
                            ...
                            this.props.in ? n !== p && n !== u && (t = p) : n !== p && n !== u || (t = h)
                        }
                        ...
                        void 0 === e && (e = !1), null !== t ? (this.cancelNextCallback(), t === p ? this.performEnter(e) : this.performExit()) : this.props.unmountOnExit && this.state.status === c && this.setState({
                            status: d
                        })
                        ...
                        t && !o ? (this.props.onExit(s), this.safeSetState({
                            status: h
                        }, (function() {
            ...
            m.contextType = l, m.propTypes = {}, m.defaultProps = { in: !1,
                ...
                onExiting: f,
                onExited: f
            }, m.UNMOUNTED = d, m.EXITED = c, m.ENTERING = p, m.ENTERED = u, m.EXITING = h;
            const x = m
        },
        7606: (e, t, n) => {
            n.d(t, {
            ...
            const w = i({
                ...
                k = function(e) {
                    ...
                    return n.map((t => `${t} ${e.duration}s ${e.timing} ${e.delay}s`)).join(", ")
                },
                y = (e, t) => (0, s.iv)(["", " ", "s ", " ", "s ", ""], t, e.duration, e.timing, e.delay, e.fill),
                C = {
                    tailEnter: v,
                    tailExit: o,
                    textEnter: w,
