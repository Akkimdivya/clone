...
(globalThis.webpackChunk_zendesk_web_widget_messenger = globalThis.webpackChunk_zendesk_web_widget_messenger || []).push([
    [5178], {
        69738: (e, r, n) => {
            ...
            var t = n(15826);
            const a = () => {
                const [e, r] = (0, t.useState)(Math.round(100 * window.devicePixelRatio)), n = () => {
                    r(Math.round(100 * window.devicePixelRatio))
                };
                return (0, t.useEffect)((() => (window.addEventListener("resize", n), () => {
        ...
        38769: (e, r, n) => {
            ...
            var t = n(98049),
                ...
                m = n(57957),
                d = n(17255);
            const c = d.ZP.div.withConfig({
                    componentId: "sc-1o8glcn-0"
                })(["height:", "px;min-width:", "px;color:", ";background-color:", ";border-radius:", "px;display:flex;justify-content:center;align-items:center;font-size:14px;padding:0 6px;", ""], 20, 20, (e => e.theme.palette.white), (e => e.theme.palette.red[500]), 20, (e => {
                    let {
                        position: r,
                        isZoomedIn: n
                    } = e;
            ...
            const w = (0, d.vJ)(["html{background-color:transparent;}"]),
                v = e => {
                    ...
                    return (0, b.jsx)(h.ZP, {
                        tabIndex: "-1",
                        title: l("embeddable_framework.messenger.unread_indicator.frame.title"),
                        hidden: !n,
                        style: {
                            zIndex: a,
                            height: o.uL,
                            ...
                            [t]: u ? v : f,
                            transform: u ? `${"right"===t?o.zz.positionRightTranslate:o.zz.positionLeftTranslate} scale(${g})` : "none",
                            border: 0,
                            marginTop: 0
                        },
        ...
        21062: (e, r, n) => {
            ...
            const t = n(17255).ZP.div.withConfig({
            ...
            const l = 1e3 * o.e + 50,
                m = e => {
                    ...
                    const d = (0, t.useCallback)((e => {
                        ...
                        if (!t ? .animate) return;
                        t.style.opacity = "0", t.style.transform = "scale(0)", r && (r.style.opacity = "0"), a && (a.style.opacity = "0");
                        t.animate([{
                            transform: "scale(0)",
                            opacity: 0
                        }, {
                            ...
                            t && t.contentDocument && (t.contentDocument.body.animate(s.dS, s.Vd), n.current.avatarFrame && (n.current.avatarFrame.style.opacity = "1", n.current.avatarFrame.animate(s.dS, s.Vd)), n.current.closeFrame && (n.current.closeFrame.style.opacity = "1", n.current.closeFrame.animate(s.dS, s.Vd)), t.contentDocument.body.style.opacity = "1")
                        }
                    }), [n]);
                    (0, t.useLayoutEffect)((() => {
                        const {
                        ...
                        } else e ? .contentDocument && (e.contentDocument.body.style.opacity = "0")
                    }), [r]);
                    return {
                        onClickAnimate: e => {
                            const {
            ...
            const m = () => {
                ...
                d = () => {
                    ...
                    return (0, t.useEffect)((() => {
                        ...
                        return l.parentWindow.addEventListener("resize", e), () => l.parentWindow.removeEventListener("resize", e)
                    }), []), e
                };
            var c = n(69738);
            const g = e => {
                let {
                    refs: r,
                    isIconNextToMessage: n
                } = e;
                const [l, m] = (0, t.useState)(0), [g, b] = (0, t.useState)(0), u = (0, c.Z)(), {
                    vertical: f,
                    horizontal: h
                } = (0, a.v9)(i.Xf), _ = d(), p = _.width - (n ? o.$l + s.$i : 0) - s.uu - (u.isZoomedIn ? 0 : h), k = Math.min(o.Oz, p), w = _.height - (0, o.b)(u.isZoomedIn ? 0 : f) - s.$i - (r.current ? .closeFrame ? .clientHeight ? s.$i + r.current ? .closeFrame ? .clientHeight : 0);
                return {
                    maxWidth: k,
                    messageFrameWidth: Math.min(l, p),
                    messageFrameHeight: Math.min(g, w),
                    messageContainerHeight: _.height - (r.current ? .closeFrame ? o.yx + s.$i : 0) - (0, o.b)(u.isZoomedIn ? 0 : f) - s.$i,
        ...
        92795: (e, r, n) => {
            ...
            var t = n(98049),
                ...
                _ = n(57957),
                p = n(55786);
            const k = (0, i.vJ)(["", " html{overflow-y:hidden;font-size:initial;", ";}"], m(), (e => e.backgroundColor && `background: ${e.backgroundColor}`)),
                w = e => {
                    let {
                        children: r,
                    ...
                    const t = (0, o.v9)(_.vb),
                        ...
                        m = (0, f.Z)();
                    (0, s.useEffect)((() => {
                        l.document.documentElement.setAttribute("dir", u.Z.isRTL() ? "rtl" : "ltr"), l.document.documentElement.setAttribute("lang", u.Z.getLocale())
                    }), [u.Z.getLocale()]);
                    return (0, p.jsx)(d.Z, {
                        currentFrame: l,
                        ...
                        labels: {
                            receipts: {
                                ...
                                status: {
                                    [c.Gs.sending]: m("embeddable_framework.messenger.receipt.sending"),
                                    [c.Gs.sent]: m("embeddable_framework.messenger.receipt.sent"),
                                    [c.Gs.failed]: m("embeddable_framework.messenger.receipt.retry")
                                },
                                errors: {
                                    ...
                                    retryButtonAriaLabel: e => m("embeddable_framework.messenger.file_upload.error.retry_button.aria_label", {
                                        errorReason: e
                                    })
                                }
                            },
                            ...
                            imageMessage: {
                                ...
                                primaryParticipantAltText: m("embeddable_framework.messenger.image_message.alt_text.end_user"),
                                otherParticipantAltText: m("embeddable_framework.messenger.image_message.alt_text.agent")
                            },
                            fileMessage: {
                            ...
                            messengerHeader: {
                                ...
                                channelLinkingMenuAriaLabel: m("embeddable_framework.messenger.channel_linking.menu"),
                            ...
                            formatTimestamp: e => {
                                const r = new Date,
                                    n = new Date(e),
                                    t = n.getDate() === r.getDate() && n.getMonth() === r.getMonth() && n.getFullYear() === r.getFullYear();
                                return `${n.toLocaleString(u.Z.getLocale(),{...t?{}:{month:"long",day:"numeric"},hour:"numeric",minute:"numeric"})}`
                            },
                            messageLog: {
                            ...
                            proactiveMessaging: {
                                proactiveMessage: {
                                    avatarAlt: e => {
                                        ...
                                        return m("embeddable_framework.messenger.proactive_message.avatar_alt", {
                                            name: r
                                        })
                                    }
                                }
                            ...
                            postbackAction: {
                                fieldError: e => {
                                    ...
                                    return m("embeddable_framework.messenger.postback_button.error.global_error_message", {
                                        errorSource: r
                                    })
                                }
                            }
                        ...
                        children: (0, p.jsxs)(p.Fragment, {
                            children: [(0, p.jsx)(k, {
                                backgroundColor: n ? t.primary : void 0
                            }), r]
                        })
                    })
                };
        ...
        82729: (e, r, n) => {
            ...
            var t = n(98049),
                ...
                m = n(55786);
            const d = (0, l.Z)(),
                c = (0, s.vJ)(["html{color:", ";}"], (e => e.theme.messenger.colors.frameText)),
                g = e => {
                    let {
                        primaryColor: r,
                        messageColor: n,
        ...
        93074: (e, r, n) => {
            ...
            var t = n(98049),
                ...
                s = n(15826),
                o = n(17255);
            const i = o.ZP.button.withConfig({
                    componentId: "sc-1ee9gtf-0"
                })(["padding:", ";border:0;width:max-content;max-width:", ";overflow-wrap:break-word;word-break:break-word;background:", ";color:", ";border-radius:", ";text-align:initial;&:focus,&:active,&:focus-visible,&[data-garden-focus-visible]{outline:0;}&:focus{outline:none;}&:focus-visible{box-shadow:inset ", ";}"], (e => e.isTitleVisible ? `${e.theme.messenger.space.sixteen} ${e.theme.messenger.space.sm} ${e.theme.messenger.space.sm}` : e.theme.messenger.space.sm), (e => "" + ("number" == typeof e.maxWidth ? `${e.maxWidth}px` : "auto")), (e => e.theme.palette.white), (e => e.theme.messenger.colors.otherParticipantMessageText), (e => e.theme.messenger.borderRadii.textMessage), (e => e.theme.shadows.md(e.theme.messenger.colors.action))),
        ...
        39707: (e, r, n) => {
            ...
            const m = s.ZP.button.withConfig({
                    componentId: "sc-1uf0igr-0"
                })(["border:0;background:", ";color:", ";border-radius:", ";display:flex;align-items:center;justify-content:center;opacity:0.8;width:", ";height:", ";transform-origin:bottom;&:focus,&:active,&:hover{opacity:1;}&:focus,&:focus-visible{box-shadow:inset ", ";outline:none;}"], (e => e.theme.palette.white), (e => e.theme.messenger.colors.iconColor), (e => e.theme.messenger.borderRadii.textMessage), (e => e.theme.messenger.iconSizes.xxl), (e => e.theme.messenger.iconSizes.xxl), (e => e.theme.shadows.md(e.theme.messenger.colors.action))),
                d = (0, s.ZP)(l).withConfig({
                    componentId: "sc-1uf0igr-1"
                })(["width:", ";height:", ";"], (e => (0, o.hO)(16, e.theme.messenger.baseFontSize)), (e => (0, o.hO)(16, e.theme.messenger.baseFontSize))),
                c = e => {
                    let {
                        onClick: r,
                        ariaLabel: n
            ...
            const d = s.forwardRef(((e, r) => {
                ...
                const [g, b] = (e => {
                    const r = (0, s.useRef)(null),
                        n = (0, s.useCallback)((n => {
                            r.current = n, e && ("function" == typeof e ? e(r.current) : e.current = r.current)
                        }), [r, e]);
                    return [r, n]
                })(r), u = (0, s.useRef)(t), [f, h] = (0, s.useState)(!1), [_, p] = (0, s.useState)(!1);
                (0, s.useEffect)((() => {
                    const e = () => {
                        h(!0)
                    };
                    if ("complete" === g.current.contentDocument.readyState) return void e();
                    const r = g.current;
                    return r.addEventListener("load", e), () => r.removeEventListener("load", e)
                }), [g]), (0, s.useEffect)((() => {
                    if (!f) return;
                    u.current || (u.current = document.createElement("div"));
                    const e = u.current,
                        r = g.current.contentDocument.body;
                    return r.appendChild(e), p(!0), () => {
                    ...
                    r || (r = e.createElement("title")), r.innerHTML = "", r.appendChild(e.createTextNode(a)), e.querySelector("head").appendChild(r)
                }), [a, _, g]);
                const k = {
                    colorScheme: "light",
                    ...c.style
                };
                return f && _ && !d || (k.display = "none"), (0, m.jsx)("iframe", {
                    ref: b,
                    title: a,
                    ...c,
                    style: k,
                    children: f && _ && (0, m.jsx)(i.LC, {
