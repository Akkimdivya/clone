window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["heatmap.continuous.manual_retaker", "survey.screenshots", "ask.popover_redesign", "feedback.embeddable_widget", "survey.type_button", "feedback.widgetV2", "sessionizer_beta_enabled", "settings.billing_v2", "survey.image_question", "client_script.compression.pc", "survey.embeddable_widget", "error_reporting"],
...
! function() {
    ...
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.abdef350bc65bc59cb61.js", "3433776"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: v,
