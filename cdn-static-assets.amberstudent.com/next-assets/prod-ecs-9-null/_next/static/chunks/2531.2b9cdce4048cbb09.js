...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2531, 16], {
        640: function(e, n, a) {
            ...
            var i = "https://prod-static-assets.amberstudent.com/images/popular-cities",
                t = [{
                    name: "London",
            ...
            var i = a(70865),
                ...
                m = (0, p.createStyles)((function(e, n) {
                    ...
                    return {
                        ...
                        btnLabel: (a = {
                            paddingRight: 20
                        }, (0, h.Z)(a, e.fn.largerThan("lg"), {
                            paddingRight: 16
                        }), (0, h.Z)(a, e.fn.largerThan("xl"), {
                            paddingRight: 0
                        }), a),
                        icon: (0, h.Z)({
                            fontSize: 14
                ...
                f = function(e) {
                    ...
                    return (0, r.jsx)(p.Button, {
                        ...
                        onClick: function() {
                            var e;
                            (i(n), l && l.current) && (null === (e = l.current) || void 0 === e || e.scrollIntoView({
                                behavior: "smooth",
                                block: "nearest",
                                inline: "start"
                            }))
                ...
                C = (0, p.createStyles)((function(e, n) {
                    ...
                    return {
                        ...
                        gridMobile: (0, t.Z)((0, i.Z)({}, k), (0, h.Z)({
                            marginTop: 12
                        }, e.fn.largerThan("md"), {
                            display: "none"
                        })),
                        gridDesktop: (0, t.Z)((0, i.Z)({}, k), (0, h.Z)({
                            display: "none"
                        }, e.fn.largerThan("md"), {
                            display: "block",
                            padding: 0,
                ...
                b = function(e) {
                    var n, a, h, m = e.isMobile,
                        ...
                        S = function(e) {
                            return function() {
                                "next" === e ? k + I >= s.ah.length ? b(0) : b((function(e) {
                                    return e + I
                                })) : "prev" === e && b(k <= 0 ? j.length - j.length % I : function(e) {
                                    return e - I
                                })
                            }
                        },
                        j = null === (n = l.jG.find((function(e) {
                            return e.name === E
                        }))) || void 0 === n ? void 0 : n.popular_cities,
                        T = (null === (h = null === (a = j.map((function(e) {
                            return (0, t.Z)((0, i.Z)({}, e), {
                                link: (0, g.s7)((null === e || void 0 === e ? void 0 : e.canonical_name) || ""),
                                image: (n = (null === e || void 0 === e ? void 0 : e.image) || "https://prod-static-assets.amberstudent.com/images/home_page_icons/pictures/london-2.jpg", "".concat(n, "?w=250&h=250&fit=crop&auto=format&trim=auto&q=10&fm=pjpg") || 0)
                            });
                            var n
                        }))) || void 0 === a ? void 0 : a.slice(k)) || void 0 === h ? void 0 : h.slice(0, I)) || [],
                        N = j.length >= I,
                        A = function(e) {
                            var n;
                            ((0, d.pr)({
                                ...
                                category: c.E0.HOME,
                                country_name: e
                            }), L && L.current) && (null === (n = L.current) || void 0 === n || n.scrollTo({
                                left: 0,
                                behavior: "smooth"
                            }));
                            b(0), w(e)
                    ...
                    return (0, r.jsx)(u.h, {
                        ...
                        subtitle: "Book student accommodations near top cities and universities around the world",
                        background: "#fff",
                        dataTestId: "popular-cities-section",
                        children: (0, r.jsxs)(p.Flex, {
                            className: K.main,
                            children: [(0, r.jsx)(p.Group, {
                                ...
                                children: l.jG.map((function(e) {
                                    return (0, r.jsx)(f, {
                                        ...
                                        onClick: A,
                                        isActive: (null === e || void 0 === e ? void 0 : e.name) === E
                                ...
                                children: [(0, r.jsx)(p.Group, {
                                    spacing: 8,
                                    noWrap: !0,
                                    children: T.slice(0, Math.ceil(T.length / 2)).map((function(e) {
                                        return (0, r.jsx)(x, {
                                            name: e.name,
                                            imageSrc: e.image,
                                            link: e.link,
                                    ...
                                    spacing: 8,
                                    noWrap: !0,
                                    children: T.slice(Math.ceil(T.length / 2)).map((function(e) {
                                        return (0, r.jsx)(x, {
                                            name: e.name,
                                            imageSrc: e.image,
                                            link: e.link,
                                ...
                                children: (0, r.jsxs)(p.Grid, {
                                    ...
                                    children: [N && (0, r.jsx)("span", {
                                        role: "navigation",
                                        className: O(K.carouselArrow, K.carouselArrowLeft),
                                        onClick: S("prev"),
                                        children: (0, r.jsx)("i", {
                                            className: "icon-arrow-left"
                                        })
                                    }), T.map((function(e) {
                                        return (0, r.jsx)(p.GridCol, {
                                            span: y ? "auto" : 2,
                                            md: 2,
                                            children: (0, r.jsx)(x, {
                                                name: e.name,
                                        ...
                                        role: "navigation",
                                        className: O(K.carouselArrow, K.carouselArrowRight),
                                        onClick: S("next"),
                                        children: (0, r.jsx)("i", {
        ...
        26793: function(e, n, a) {
            ...
            var i = a(52322),
                ...
                s = (0, t.createStyles)((function(e, n) {
                    var a, i = n.background;
                    return {
                        container: {
                            backgroundColor: null !== i && void 0 !== i ? i : e.colors.neutral[0]
                        },
                        innerContainer: (a = {
                            padding: "32px 16px"
        ...
        70016: function(e, n, a) {
            ...
            var i = a(8388),
                ...
                s = 1441,
                d = "".concat(t().app.image_static_assets_url, "/images/wechat-qr.png?auto=format&q=10"),
                g = "".concat(t().app.image_static_assets_url, "/images/xhr_qr.jpg?auto=format&q=10")
        }
    }
]);
