    ...
    [8185, 16], {
        48185: function(e, i, c) {
            ...
            var t = c(66383),
                ...
                d = (0, s.kc)((function(e) {
                    ...
                    return {
                        stickyBar: (i = {
                            ...
                            zIndex: 180,
                            display: "block"
                        }, (0, p.Z)(i, e.fn.largerThan("md"), {
                            display: "none"
                        }), (0, p.Z)(i, "height", "calc(55px + env(safe-area-inset-bottom))"), (0, p.Z)(i, "transition", "height 200ms linear"), i),
                        hide: {
                            height: "0px"
                        },
                        navIcon: {
                ...
                C = function(e) {
                    var i, c, p = e.active,
                        ...
                        b = function(e, i) {
                            return function() {
                                ...
                                (0, a.pr)({
                                    action: i,
                                    category: _.GH.BOTTOM_NAV
                                });
                                var t = (null === (c = window.location) || void 0 === c ? void 0 : c.pathname) || "";
                                t.startsWith("/places/search/") && localStorage.setItem(h, t), window.open(e, "_self")
                            }
                        },
                        w = [{
                            label: "Explore",
                            icon: (0, o.jsx)("i", {
                                className: "icon-bnav-home"
                            }),
                            iconActive: (0, o.jsx)("i", {
                                className: "icon-bnav-home-filled"
                            }),
                            onClick: (c = L, function() {
                                (0, a.pr)({
                                    action: c,
                                    category: _.GH.BOTTOM_NAV
                                });
                                var e = localStorage.getItem(h);
                                e ? (localStorage.removeItem(h), window.open(e, "_self")) : window.open("/", "_self")
                            })
                        }, {
                            label: "Shortlist",
                            icon: (0, o.jsx)("i", {
                            ...
                            highlight: Boolean("Shortlist" !== p && (null === u || void 0 === u || null === (i = u.inventories_shortlists_ids) || void 0 === i ? void 0 : i.length))
                        }, {
                            label: "Chat",
                            icon: (0, o.jsx)("i", {
                    ...
                    return (0, n.useEffect)((0, s.P2)((function() {
                        var e = I.current - m.y;
                        e > 0 && Math.abs(e) > 30 && x(!0), e < 0 && Math.abs(e) > 30 && x(!1), I.current = m.y, m.y < 20 && x(!0)
                    }), 500), [m.y]), (0, o.jsx)(o.Fragment, {
                                ...
                                children: w.map((function(e) {
                                    ...
                                    return (0, o.jsxs)(l.Flex, {
                                        ...
                                        children: [(0, o.jsxs)(l.Flex, {
                                            className: "".concat(E.navIcon, " ").concat(i === p ? "active" : ""),
                                            align: "center",
                                            children: [a && (0, o.jsx)(l.Box, {
                                                className: E.highlight,
                                                bg: "primary.5"
                                            }), i === p ? t : (0, o.jsx)(l.Flex, {
                                                className: E.notActiveIcon,
                                                children: c
                                            })]
                                        }), (0, o.jsx)(l.Text, {
                                            color: i === p ? "primary.5" : "neutral.5",
                                            size: "11px",
                                            lh: "13.61px",
                                            fw: i === p ? 600 : 500,
                                            children: i
        ...
        70016: function(e, i, c) {
            ...
            var t = c(8388),
                ...
                s = 1441,
                _ = "".concat(o().app.image_static_assets_url, "/images/wechat-qr.png?auto=format&q=10"),
                p = "".concat(o().app.image_static_assets_url, "/images/xhr_qr.jpg?auto=format&q=10")
        }
    }
]);
