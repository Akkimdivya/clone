        ...
        45572: function(e, t, n) {
            ...
            var o = n(52322),
                        ...
                        return (0, u.__generator)(this, (function(o) {
                            switch (o.label) {
                                case 0:
                                    e = (0, f.C9)(), o.label = 1;
                                case 1:
                                    return o.trys.push([1, 3, , 4]), [4, window.AppleID.auth.signIn()];
                                case 2:
                                    return t = o.sent(), (0, f.OP)({
                                ...
                                case 3:
                                    return n = o.sent(), h.r.log(n), (0, d.pr)({
                ...
                g = function(e) {
                    return function() {
                        ! function(e, t) {
                            window.fbAsyncInit(), window.FB.login((function(e) {
                                return e.authResponse ? (0, f.OP)({
                ...
                b = function() {
                    ...
                    return (0, x.useEffect)((function() {
                        t && e && e.current && function(e) {
                            try {
                                var t, n;
                                e && google && (null === google || void 0 === google || null === (t = google.accounts) || void 0 === t || null === (n = t.id) || void 0 === n || n.renderButton(e, {
                                ...
                                try {
                                    var o, r;
                                    null === google || void 0 === google || null === (o = google.accounts) || void 0 === o || null === (r = o.id) || void 0 === r || r.renderButton(e, {
                ...
                y = function() {
                    ...
                    return (0, o.jsxs)(s.Flex, {
                        gap: 16,
                        children: [i().global.isChinaApp ? (0, o.jsx)(v, {
                            title: "WeChat",
            ...
            var o = n(70865),
                ...
                d = function() {
                    ...
                    return (0, r.jsxs)("form", {
                        onSubmit: h,
                        children: [(0, r.jsx)(a.TextInput, (0, o.Z)({
                            label: "Email Address",
                            placeholder: "Enter your email address",
                            autoComplete: "email",
                            error: null === (e = n.formState.errors.email) || void 0 === e ? void 0 : e.message,
                            fz: 14,
                            fw: 400
                        }, n.register("email", {
                            pattern: {
                ...
                p = function() {
                    ...
                    return (0, r.jsxs)(a.Text, {
                        ...
                        mt: e ? 30 : 24,
                        className: t.footer,
                        children: ["By signing in you agree to our\xa0", (0, r.jsx)(a.Text, {
                            color: "primary.5",
                            fw: 400,
                            component: "a",
                            href: "/privacy",
                ...
                h = (n(8388), n(35590), (0, a.createStyles)((function(e, t) {
                    var n = t.disabled;
                    return {
                        text: (0, o.Z)({
                            whiteSpace: "nowrap",
                ...
                g = function() {
                    ...
                    var v = n.handleSubmit((function(e) {
                        b(!0), (0, l.gl)({
                            ...
                            onFailure: function(e) {
                                e && 400 === e.status ? (0, l.oz)() : (0, l.an)(), n.setError("otp", {
                    ...
                    return (0, i.useEffect)((function() {
                        ...
                        children: [(0, r.jsxs)(a.Group, {
                        ...
                        }), (0, r.jsx)(a.TextInput, (0, o.Z)({
                            inputMode: "numeric",
                            autoComplete: "one-time-code",
                            label: "OTP",
                            placeholder: "Enter OTP",
                            error: null === (e = n.formState.errors.otp) || void 0 === e ? void 0 : e.message,
                            fz: 14,
                            fw: 400
                        }, n.register("otp", {
                            pattern: {
                            ...
                            children: [(0, r.jsx)(a.Text, {
                                ...
                                disabled: p > 0,
                                children: ["Resend ", p > 0 && (0, r.jsxs)(r.Fragment, {
                                    children: ["(", p, "s)"]
                                })]
                            })]
                        })]
