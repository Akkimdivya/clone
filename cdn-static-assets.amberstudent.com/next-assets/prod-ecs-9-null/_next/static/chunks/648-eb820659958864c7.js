        ...
        90648: function(n, e, t) {
            ...
            var a = t(98788),
                        ...
                        children: [(0, i.jsx)(m.Text, {
                            ...
                            children: [(0, i.jsx)(m.Anchor, {
                                ...
                                children: (0, i.jsx)("img", {
                                    src: "".concat(c().app.image_static_assets_url, "/images/playStoreAppQR-hd.png"),
                                    alt: "play store",
                                    className: n.img
                                })
                            }), (0, i.jsx)(m.Anchor, {
                                ...
                                underline: !1,
                                children: (0, i.jsx)("img", {
                                    src: "".concat(c().app.image_static_assets_url, "/images/appStoreAppQR-hd.png"),
                                    alt: "app store",
                                    className: n.img
                                })
                            })]
                    ...
                    return (0, i.jsxs)(m.Flex, {
                        ...
                        children: [_.map((function(n, e) {
                            return (0, i.jsxs)(m.Text, {
                                ...
                                children: [n.link && (0, i.jsx)("script", {
                                    type: "application/ld+json",
                                    dangerouslySetInnerHTML: {
                            ...
                            children: [(0, i.jsx)(m.Text, {
                                ...
                                width: 240,
                                height: 40,
                                src: "".concat(c().app.image_static_assets_url, "/images/cards.png"),
                                alt: "amber-cards",
                                loading: "lazy"
                            })]
                        })]
                ...
                N = function() {
                    ...
                    return (0, i.jsxs)(m.Box, {
                        ...
                        children: [(0, i.jsxs)(m.Flex, {
                            ...
                            gap: 2,
                            children: [(0, i.jsx)("img", {
                                src: "".concat(c().app.image_static_assets_url, "/images/star.svg"),
                                alt: "trsutpilot-star",
                                height: 20,
                                width: 20
                            }), (0, i.jsx)(m.Text, {
                            ...
                            src: "".concat(c().app.image_static_assets_url, "/images/trustpilot-rating.svg"),
                            alt: "amber-trustpilot",
                            width: "124px",
                            height: "24px"
                        }), (0, i.jsxs)(m.Text, {
                            className: n.mainText,
                            children: ["Trustscore ", (0, i.jsxs)("span", {
                                children: [y.H, "/5"]
                            })]
                        }), (0, i.jsxs)(m.Text, {
                            className: n.mainText,
                            children: [(0, i.jsxs)("span", {
                                children: [y.S.ROUNDED, " "]
                            }), "Student reviews"]
                        })]
                    })
                },
                    ...
                    return (0, i.jsxs)(m.Box, {
                        ...
                        children: [(0, i.jsxs)(m.Flex, {
                            ...
                            children: [(0, i.jsx)("img", {
                                ...
                                height: 18,
                                src: "".concat(c().app.image_static_assets_url, "/images/trustpilotFooterV2.png"),
                ...
                A = [{
                    ...
                    icon: c().global.isChinaApp ? "icon-wechat-green-outline" : "icon-whatsapp",
                    label: c().global.isChinaApp ? "WeChat" : "WhatsApp",
                    link: c().global.isChinaApp ? s.mx : s.s7
                }, {
                    icon: "icon-all-regions",
                    label: s.XM,
                    link: "https://www.google.com/search?q=".concat(encodeURIComponent(s.XM))
                }],
                W = function() {
                        ...
                        return (0, r.__generator)(this, (function(r) {
                            switch (r.label) {
                                ...
                                case 1:
                                    switch (n = r.sent(), e = {
                                        icon: "icon-phone",
                                        label: "".concat(s._8.country_code, " ").concat(s._8.number),
                                        link: "tel: ".concat(s._8.full_number)
                                    }, t = {
                                        icon: "icon-phone",
                                        label: "".concat(s.vt.country_code, " ").concat(s.vt.number),
                                        link: "tel: ".concat(s.vt.full_number)
                                    }, a = {
                                        icon: "icon-phone",
                                        label: "".concat(s.jb.country_code, " ").concat(s.jb.number),
                                        link: "tel: ".concat(s.jb.full_number)
                                    }, i = {
                                        icon: "icon-phone",
                                        label: "".concat(s.g8.country_code, " ").concat(s.g8.number),
                ...
                H = (0, m.createStyles)((function(n, e) {
                    ...
                    return {
                        ...
                        }, (0, u.Z)(t, n.fn.largerThan("md"), {
                            margin: "56px 80px"
                        }), (0, u.Z)(t, n.fn.largerThan(a), {
                            margin: "56px auto",
                            maxWidth: 1440
                        }), (0, u.Z)(t, n.fn.largerThan("1601"), {
                            maxWidth: 1640
                        }), t),
                        mainContainer: (0, u.Z)({
                ...
                L = function() {
                    ...
                    return (0, o.useEffect)((function() {
                        var n;
                        c().zendesk.isVisible && !c().global.isChinaApp && function() {
                            var n = document.createElement("script");
                            n.id = "ze-snippet", n.src = c().zendesk.url, n.defer = !0, n.onload = function() {
                        ...
                        return t(), window.addEventListener("beforeunload", e), "amberstudent.cn" === (null === window || void 0 === window || null === (n = window.location) || void 0 === n ? void 0 : n.host) && k(!0),
                            function() {
                        ...
                        children: [(0, i.jsx)(m.Box, {
                            className: e.mainContainer,
                            children: (0, i.jsxs)(m.Grid, {
                                columns: 20,
                                children: [(0, i.jsxs)(m.GridCol, {
                                    xl: 6,
                                    lg: 6,
                                    md: 20,
                                    xs: 20,
                                    ...
                                    children: [(0, i.jsx)("img", {
                                        src: "".concat(c().app.image_static_assets_url, "/images/logo/amber-logo-text-black.png?auto=format"),
                                        ...
                                        children: "Book your student accommodation near top universities across the globe"
                                    }), (0, i.jsxs)(m.Box, {
                                ...
                                }), (null === c() || void 0 === c() || null === (n = c().global) || void 0 === n ? void 0 : n.isChinaApp) ? (0, i.jsxs)(m.Group, {
                                    w: "100%",
                                    position: "apart",
                        ...
                        }), (0, i.jsx)(v, {}), b && (0, i.jsx)(m.Text, {
                            fz: "10px",
                            color: "neutral.7",
                            children: "Shanghai ICP No. 2023031604-1 | Shanghai Hande Zhenling Information Technology Co., Ltd."
                        })]
                    })
                }
        }
