    ...
    [7873, 16], {
                ...
                l = (0, o.forwardRef)((function(e, t) {
                    ...
                    return (0, o.useEffect)((function() {
                        var e = function() {
                            ...
                            t = function(e, t) {
                                var n = null === t || void 0 === t ? void 0 : t.getBoundingClientRect(),
                                    a = Math.ceil(n.right),
                                    i = Math.ceil(n.left),
                                    r = null === e || void 0 === e ? void 0 : e.getBoundingClientRect(),
                                    o = f ? Math.ceil(r.right) - 1 : Math.ceil(r.right),
                                    l = Math.ceil(r.left);
                                return i > l && a < o ? "both" : l < i ? "left" : o > a ? "right" : "none"
                            },
                            n = {
                                navBarTravelling: !1,
                        ...
                        r.addEventListener("scroll", (function() {
                            ...
                            if (!0 !== n.navBarTravelling) {
                                if ("left" === t(o, r) || "both" === t(o, r)) {
                                    var a = r.scrollLeft;
                                    a < 2 * n.navBarTravelDistance ? o.style.transform = "translateX(" + a + "px)" : o.style.transform = "translateX(" + n.navBarTravelDistance + "px)", o.classList.remove("scroll-box-contents-no-transition"), n.navBarTravelDirection = "left", n.navBarTravelling = !0
                                }
                                e()
                            }
                            ...
                            if (!0 !== n.navBarTravelling) {
                                if ("right" === t(o, r) || "both" === t(o, r)) {
                                    var a, i, l = null === (a = null === o || void 0 === o ? void 0 : o.getBoundingClientRect()) || void 0 === a ? void 0 : a.right,
                                        s = null === (i = null === r || void 0 === r ? void 0 : r.getBoundingClientRect()) || void 0 === i ? void 0 : i.right,
                                        c = Math.floor(l - s);
                                    c < 2 * n.navBarTravelDistance ? o.style.transform = "translateX(-" + c + "px)" : o.style.transform = "translateX(-" + n.navBarTravelDistance + "px)", o.classList.remove("scroll-box-contents-no-transition"), n.navBarTravelDirection = "right", n.navBarTravelling = !0
                                }
                                e()
                            }
                            ...
                            o.style.transform = "none", o.classList.add("scroll-box-contents-no-transition"), "left" === n.navBarTravelDirection ? r.scrollLeft = r.scrollLeft - a : r.scrollLeft = r.scrollLeft + a, n.navBarTravelling = !1
                        }), !1)
                    }), []), (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)("nav", {
                            ...
                            ref: t,
                            onScroll: c,
                            children: (0, r.jsx)("div", (0, i.Z)((0, a.Z)({
                                ...
                                children: n.map((function(e, t) {
                                    var a = [];
                                    return 0 === t && a.push("scroll-box-item-first"), t + 1 == n.length && a.push("scroll-box-item-last"), (0, r.jsx)("div", {
                                        className: "scroll-box-item ".concat(m ? "with-padding-right" : "", " ").concat(a.join(" ")),
                                        role: "listitem",
                                        children: e
        ...
        26793: function(e, t, n) {
            ...
            var a = n(52322),
                ...
                c = (0, i.createStyles)((function(e, t) {
                    var n, a = t.background;
                    return {
                        container: {
                            backgroundColor: null !== a && void 0 !== a ? a : e.colors.neutral[0]
                        },
                        innerContainer: (n = {
                            padding: "32px 16px"
        ...
        23911: function(e, t, n) {
            ...
            var a = n(52322),
                ...
                g = function() {
                    ...
                    if ("" === e) return e;
                    var t = e.split(" ");
                    return 1 === t.length ? t[0].charAt(0).toUpperCase() : t[0].charAt(0).toUpperCase() + t[t.length - 1].charAt(0).toUpperCase()
                },
                u = n(8388),
                m = n.n(u),
                p = function(e) {
                    ...
                    return (0, a.jsxs)(o.Flex, {
                        ...
                        children: [(0, a.jsxs)(o.Flex, {
                            ...
                            src: "".concat(m().app.image_static_assets_url, "/images/trustpilot-rating.svg"),
                    ...
                    return (0, a.jsx)(o.Modal, {
                        ...
                        children: (0, a.jsxs)(o.Flex, {
                            ...
                            children: [(0, a.jsx)(p, {
                                ...
                                subtext: r,
                                personImage: l
                            }), (0, a.jsx)(o.Divider, {}), (0, a.jsx)(o.Text, {
                                fw: 400,
                                lh: "21px",
                                color: "neutral.8",
                                className: c.readMoreContent,
                                children: s
                            }), (0, a.jsx)(o.Divider, {}), (0, a.jsx)(o.Button, {
                                w: "100%",
                                mt: 8,
                                color: "secondary.5",
                                size: "lg",
                ...
                x = function(e) {
                    var t = e.name,
                        ...
                        b = x[1],
                        w = function(e) {
                            return "".concat(m().app.image_static_assets_url, "/images/testimonials/").concat(e, "?fm=pjpg&auto=format")
                        };
                    return (0, c.useEffect)((function() {
                        if (g.current) {
                            var e;
                            (null === g || void 0 === g || null === (e = g.current) || void 0 === e ? void 0 : e.scrollHeight) > 90 && d(!0)
                        }
                    }), []), (0, a.jsxs)(o.Flex, {
                ...
                b = function() {
                    ...
                    return (0, a.jsxs)(o.Flex, {
                        ...
                        onClick: function() {
                            return window && (null === window || void 0 === window ? void 0 : window.open(i.S4, "_blank"))
                        },
                        children: [(0, a.jsxs)(o.Flex, {
                            direction: "row",
                            gap: 4,
                            children: [(0, a.jsx)("img", {
                                src: "".concat(m().app.image_static_assets_url, "/images/star.svg"),
                                alt: "trsutpilot-star",
                                height: 20,
                                width: 20
                            }), (0, a.jsx)(o.Text, {
                ...
                w = [{
                    ...
                    testimonial: "The best service I could ask for an international student. Awesome, great follow-up services that helped me throughout the process from start to the end. Thanks to Amber for a great facility!",
                    personImage: "pavneech.png"
                }, {
                    name: "Heramb Uttarwar",
                    subtext: "Illinois Institute of Technology",
                    testimonial: "It was an amazing experience with amberstudent. The work they do is really appreciable. The only thing we need to do is to provide details. The people at amberstudent provide great support.",
                    personImage: "heramb.jpg"
                }, {
                    name: "Simon Langer",
                    subtext: "Plymouth College of Art",
                    testimonial: "Experience was amazing!! I\u2019m going to Plymouth College of Art. Great prices & the rent durations are negotiable. Also as an art student I do appreciate the website design \u2014 its clear, visible & well placed.",
                ...
                _ = [{
                    ...
                    testimonial: "I am going to study at UCL and Supreet from Amber did an excellent job in helping me. I do not have doubt to recommend Supreet as a student helper. I hope to receive his help in future. The room is in an excellent location.",
                    personImage: "Robert.png"
                }, {
                    name: "Quezia Jones",
                    subtext: "Lancaster University",
                    testimonial: "Great assistance! They can find the perfect location for you, under the specifications you have given them. They have 24/7 support for you, they reply quickly and explain everything (more than 1 time if needed) about any of your queries. I surely recommend it."
                }, {
                    name: "Bambee",
                    subtext: "The University of Queensland",
                    testimonial: "I was desperately finding a room here in brisbane, it was so hard even with the student accomodation. I was having this problem for like 3 months, but with Amber assistance.. oh wow only one day I already has a room for myself for another year. Thank you so much!!\u2764\ufe0f"
                }, {
                    name: "Satya",
                    subtext: "Illinois Institute of Technology",
                    testimonial: "I was on a tight deadline and under many constraints. AmberStudent really helped in what would otherwise have been a very stressful housing hunt! Thank you!"
                }],
                T = function(e) {
                    var t = e.country,
                        n = e.deviceInfo,
                        ...
                        g = e.description,
                        u = h().classes,
                        m = "GB" === (null === t || void 0 === t ? void 0 : t.short_name) ? w : _;
                    return (0, a.jsxs)(s.h, {
                        title: d || "What do students have to say about us?",
                        subtitle: g || "Over 1M students trust amber for their student housing needs ;)",
                        background: c,
                        dataTestId: "testimonials-section",
                        children: [(0, a.jsx)(b, {}), (0, a.jsx)(l.C, {
                            ...
                            color: "primary.4",
                            variant: "secondary",
                            size: (null === n || void 0 === n ? void 0 : n.mobile) ? "md" : "lg",
                            href: i.S4,
                            classNames: {
                                root: u.root,
                                label: u.label
        ...
        70016: function(e, t, n) {
            ...
            var a = n(8388),
                ...
                c = 1441,
                d = "".concat(i().app.image_static_assets_url, "/images/wechat-qr.png?auto=format&q=10"),
                h = "".concat(i().app.image_static_assets_url, "/images/xhr_qr.jpg?auto=format&q=10")
        }
    }
]);
