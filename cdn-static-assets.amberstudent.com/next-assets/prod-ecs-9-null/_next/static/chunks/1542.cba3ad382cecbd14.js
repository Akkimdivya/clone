    ...
    [1542, 16], {
                ...
                l = (0, i.forwardRef)((function(e, t) {
                    ...
                    return (0, i.useEffect)((function() {
                        var e = function() {
                            ...
                            t = function(e, t) {
                                var n = null === t || void 0 === t ? void 0 : t.getBoundingClientRect(),
                                    ...
                                    l = Math.ceil(o.left);
                                return r > l && a < i ? "both" : l < r ? "left" : i > a ? "right" : "none"
                            },
                            n = {
                                navBarTravelling: !1,
                        ...
                        o.addEventListener("scroll", (function() {
                            ...
                            if (!0 !== n.navBarTravelling) {
                                if ("left" === t(i, o) || "both" === t(i, o)) {
                                    var a = o.scrollLeft;
                                    a < 2 * n.navBarTravelDistance ? i.style.transform = "translateX(" + a + "px)" : i.style.transform = "translateX(" + n.navBarTravelDistance + "px)", i.classList.remove("scroll-box-contents-no-transition"), n.navBarTravelDirection = "left", n.navBarTravelling = !0
                                }
                                e()
                            }
                            ...
                            if (!0 !== n.navBarTravelling) {
                                if ("right" === t(i, o) || "both" === t(i, o)) {
                                    var a, r, l = null === (a = null === i || void 0 === i ? void 0 : i.getBoundingClientRect()) || void 0 === a ? void 0 : a.right,
                                        c = null === (r = null === o || void 0 === o ? void 0 : o.getBoundingClientRect()) || void 0 === r ? void 0 : r.right,
                                        s = Math.floor(l - c);
                                    s < 2 * n.navBarTravelDistance ? i.style.transform = "translateX(-" + s + "px)" : i.style.transform = "translateX(-" + n.navBarTravelDistance + "px)", i.classList.remove("scroll-box-contents-no-transition"), n.navBarTravelDirection = "right", n.navBarTravelling = !0
                                }
                                e()
                            }
                            ...
                            i.style.transform = "none", i.classList.add("scroll-box-contents-no-transition"), "left" === n.navBarTravelDirection ? o.scrollLeft = o.scrollLeft - a : o.scrollLeft = o.scrollLeft + a, n.navBarTravelling = !1
                        }), !1)
                    }), []), (0, o.jsxs)("div", {
                        ...
                        children: [(0, o.jsx)("nav", {
                            ...
                            ref: t,
                            onScroll: s,
                            children: (0, o.jsx)("div", (0, r.Z)((0, a.Z)({
                                ...
                                children: n.map((function(e, t) {
                                    var a = [];
                                    return 0 === t && a.push("scroll-box-item-first"), t + 1 == n.length && a.push("scroll-box-item-last"), (0, o.jsx)("div", {
                                        className: "scroll-box-item ".concat(g ? "with-padding-right" : "", " ").concat(a.join(" ")),
                                        role: "listitem",
                                        children: e
            ...
            var a = n(52322),
                ...
                d = function(e) {
                    ...
                    return (0, a.jsx)(l.h, {
                        ...
                        title: null !== t && void 0 !== t ? t : "Amber Referral Program and Offers",
                        subtitle: null !== n && void 0 !== n ? n : "Several promotions, deals and special offers crafted just for you.",
                            ...
                            children: (0, a.jsx)(i.C, {
                                ...
                                children: o.jn.map((function(e, t) {
                                    return (0, a.jsx)(o.fm, {
                                        ...
                                        imageTablet: e.imageTablet,
                                        imageAlt: e.imageAlt,
                                        redirect: e.redirect,
                                        utmSource: u,
                                        lastIndexElement: t === o.jn.length - 1
                                    }, t)
                                }))
                            })
                        })
        ...
        70016: function(e, t, n) {
            ...
            var a = n(8388),
                ...
                s = 1441,
                d = "".concat(r().app.image_static_assets_url, "/images/wechat-qr.png?auto=format&q=10"),
                u = "".concat(r().app.image_static_assets_url, "/images/xhr_qr.jpg?auto=format&q=10")
        },
        2969: function(e, t, n) {
            n.d(t, {
                jn: function() {
            ...
            var a = n(52322),
                ...
                d = function() {
                    ...
                    return (0, a.jsxs)(a.Fragment, {
                        children: ["Save up to ", (0, a.jsx)("span", {
                            className: e.amberPlusTitle,
                            children: "\xa3300"
                        }), " with amber", (0, a.jsx)("span", {
                            className: e.amberPlusTitle,
                            children: "+"
                        })]
                    })
                ...
                f = [{
                    title: "Win \xa350 in just a few steps! Refer a friend and earn your reward",
                    content: "Turn connections into rewards. Get credited after successful booking.",
                    cta: "Refer Now",
                    imageWeb: "".concat(u, "refer-payment-flow-new.png?auto=format&q=10"),
                    ...
                    content: "Save \xa35,000 and turn your education dreams into a reality.",
                    cta: "Apply Now",
                    imageWeb: "".concat(u, "scholarship.jpg?auto=format&q=10"),
                    imageTablet: "".concat(u, "scholarshoip-offer+1.png?auto=format&q=10"),
                    imageMobile: "".concat(u, "scholarship-offer-mobile+2.png?auto=format&q=10"),
                    ...
                    title: (0, a.jsx)(d, {}),
                    content: "Get exclusive discounts from 150+ trusted partners at this one-stop student platform",
                    cta: "Claim Now",
                ...
                h = (0, c.createStyles)((function(e, t) {
                    ...
                    return {
                        ...
                        offerCardContentSectionWrapper: {
                            height: "100%"
                        },
                        ...
                        titleUnderline: (0, l.Z)({
                            maxWidth: "65%",
                            height: 8,
                            background: "linear-gradient(90deg, ".concat(c, " 0%, ").concat(s, " 101.95%)"),
                            marginTop: 12
                        }, e.fn.largerThan("md"), {
                        ...
                        onClick: function() {
                            return function(e, t) {
                                (0, m.pr)({
                                    ...
                                    category: r.E0.HOME,
                                    refer_title: e
                                }), t && window.open(function(e, t, n) {
                                    var a = "".concat(e).concat(t);
                                    return n && (a = "".concat(a, "?utm_source=").concat(n)), a
                                }(window.location.origin, s, x), "_blank")
                            }(t, f)
                        },
                        children: [(0, a.jsxs)(c.Box, {
