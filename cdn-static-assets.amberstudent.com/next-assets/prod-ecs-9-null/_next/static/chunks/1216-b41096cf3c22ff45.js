    ...
    [1216, 16], {
                        ...
                        children: (0, r.jsx)(a.Flex, {
                            ...
                            children: (0, r.jsx)(l.Z, {
                                ...
                                children: null === t || void 0 === t ? void 0 : t.map((function(e, n) {
                                    return (0, r.jsxs)(a.Group, {
                                        className: f.bookingStepCardWrapper,
                                        children: [(0, r.jsx)(d, {
                                            cardData: e,
                                            index: n
                                        }), n !== t.length - 1 && (0, r.jsx)("i", {
                                            className: "icon-step-arrow-right ".concat(f.rightArrow)
                                        })]
                                    }, "BookingStepCard_".concat(n))
                                }))
                            })
                        })
                    })
                ...
                o = (0, l.forwardRef)((function(e, t) {
                    ...
                    return (0, l.useEffect)((function() {
                        var e = function() {
                            ...
                            t = function(e, t) {
                                var n = null === t || void 0 === t ? void 0 : t.getBoundingClientRect(),
                                    ...
                                    o = Math.ceil(i.left);
                                return a > o && r < l ? "both" : o < a ? "left" : l > r ? "right" : "none"
                            },
                            n = {
                                navBarTravelling: !1,
                        ...
                        i.addEventListener("scroll", (function() {
                            ...
                            if (!0 !== n.navBarTravelling) {
                                if ("left" === t(l, i) || "both" === t(l, i)) {
                                    var r = i.scrollLeft;
                                    r < 2 * n.navBarTravelDistance ? l.style.transform = "translateX(" + r + "px)" : l.style.transform = "translateX(" + n.navBarTravelDistance + "px)", l.classList.remove("scroll-box-contents-no-transition"), n.navBarTravelDirection = "left", n.navBarTravelling = !0
                                }
                                e()
                            }
                            ...
                            if (!0 !== n.navBarTravelling) {
                                if ("right" === t(l, i) || "both" === t(l, i)) {
                                    var r, a, o = null === (r = null === l || void 0 === l ? void 0 : l.getBoundingClientRect()) || void 0 === r ? void 0 : r.right,
                                        c = null === (a = null === i || void 0 === i ? void 0 : i.getBoundingClientRect()) || void 0 === a ? void 0 : a.right,
                                        s = Math.floor(o - c);
                                    s < 2 * n.navBarTravelDistance ? l.style.transform = "translateX(-" + s + "px)" : l.style.transform = "translateX(-" + n.navBarTravelDistance + "px)", l.classList.remove("scroll-box-contents-no-transition"), n.navBarTravelDirection = "right", n.navBarTravelling = !0
                                }
                                e()
                            }
                            ...
                            l.style.transform = "none", l.classList.add("scroll-box-contents-no-transition"), "left" === n.navBarTravelDirection ? i.scrollLeft = i.scrollLeft - r : i.scrollLeft = i.scrollLeft + r, n.navBarTravelling = !1
                        }), !1)
                    }), []), (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)("nav", {
                            ...
                            ref: t,
                            onScroll: s,
                            children: (0, i.jsx)("div", (0, a.Z)((0, r.Z)({
                                ...
                                children: n.map((function(e, t) {
                                    var r = [];
                                    return 0 === t && r.push("scroll-box-item-first"), t + 1 == n.length && r.push("scroll-box-item-last"), (0, i.jsx)("div", {
                                        className: "scroll-box-item ".concat(u ? "with-padding-right" : "", " ").concat(r.join(" ")),
                                        role: "listitem",
                                        children: e
        ...
        70016: function(e, t, n) {
            ...
            var r = n(8388),
                ...
                g = "".concat(a().app.image_static_assets_url, "/images/xhr_qr.jpg?auto=format&q=10")
        }
    }
]);
