            ...
            var i = o(52322),
                ...
                d = function(n) {
                    ...
                    (0, c.useEffect)((function() {
                        var n;
                        return x && (e !== a.E0.SEARCH && "function" === typeof d && "false" === (0, t.ej)("showAppBanner") ? d() : l && (n = setTimeout((function() {
                                "undefined" !== typeof gtag && gtag("event", "app_download_option_shown", {
                        ...
                        children: l && (0, i.jsxs)(r.Flex, {
                            ...
                            children: [!u && (0, i.jsx)("div", {
                                onClick: function() {
                                    ...
                                    var n = new Date;
                                    n.setTime(n.getTime() + 1728e5), window.document.cookie = "showAppBanner=false;expires=".concat(n.toGMTString(), ";path=/;"), d()
                                },
            ...
            var i = o(98788),
                ...
                _ = function(n) {
                    ...
                    return (0, t.useEffect)((function() {
                                ...
                                return (0, c.__generator)(this, (function(e) {
                                    switch (e.label) {
                                        case 0:
                                            return [4, (0, m.J)()];
                                        case 1:
                                            return null !== (n = e.sent() || "GB") && void 0 !== n && Y[n] && X(n), [2]
                                    }
                                }))
                            }));
                            return function() {
                        ...
                        children: [l().global.is_smartcat_enabled && l().global.isChinaApp && (0, a.jsx)(j.s, {
                            label: "Language",
                            icon: (0, a.jsx)("i", {
                            ...
                            children: (0, a.jsxs)(g.Box, {
                                ...
                                }), l().global.isChinaApp ? (0, a.jsx)(j.s, {
                                    label: "WeChat",
                                    icon: (0, a.jsx)("i", {
                            ...
                            icon: (0, a.jsx)("i", {
                                className: "".concat(C.partnerIcon, " icon-partner-with-us")
                            }),
                            redirectTo: s.n,
                            clickHandler: function() {
                                return W({
                            ...
                            className: C.divider
                        }), !l().global.isChinaApp && (0, a.jsx)(g.Flex, {
                            className: C.appBanner,
                            children: (0, a.jsx)(b.Q, {
                                from: s.Rh,
                                showAppBanner: !0
                            })
                        }), e.status ? (0, a.jsx)(j.s, {
                            icon: (0, a.jsx)("i", {
            ...
            var i = o(2784),
                ...
                d = function(n) {
                    ...
                    (0, i.useEffect)((function() {
                        ! function() {
                            var n, e = localStorage.getItem("wglang") || "en",
                                o = null === (n = c.f1.find((function(n) {
                                    return n.value === e
                    ...
                    return {
                        ...
                        handleLanguageChange: function(n) {
                            ...
                            var t = window.location.pathname,
                                ...
                                p = ".".concat(null === l() || void 0 === l() || null === (o = l().urls) || void 0 === o ? void 0 : o.web_service_hostname) || 0;
                            window.document.cookie = "wglang=".concat(r, ";domain=").concat(p, ";path=/;"), localStorage.setItem("wglang", n), e(s, r), window.location.href = d
                        }
                    }
                }
        }
