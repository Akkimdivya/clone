    ...
    [7448, 1695, 16], {
                ...
                E = function() {
                    var e = (0, t.Z)((function() {
                        ...
                        return (0, n.__generator)(this, (function(n) {
                            switch (n.label) {
                                case 0:
                                    return n.trys.push([0, 2, , 3]), _ = l()(i().urls.web_service_url, "/places/getCountryData"), [4, C().get(_)];
                                case 1:
                                    return c = n.sent(), [2, (null === c || void 0 === c || null === (e = c.body) || void 0 === e ? void 0 : e.country) || "GB"];
                                case 2:
                                    return t = n.sent(), u.r.error("Error fetching country data:", t), [2, "GB"];
                                case 3:
                                    return [2]
                            }
                        }))
        ...
        70016: function(e, _, c) {
            ...
            var t = c(8388),
                ...
                C = 1441,
                o = "".concat(n().app.image_static_assets_url, "/images/wechat-qr.png?auto=format&q=10"),
                l = "".concat(n().app.image_static_assets_url, "/images/xhr_qr.jpg?auto=format&q=10")
        }
    }
]);
