    ...
    [4279, 16], {
        26793: function(t, e, n) {
            ...
            var r = n(52322),
                ...
                l = (0, a.createStyles)((function(t, e) {
                    var n, r = e.background;
                    return {
                        container: {
                            backgroundColor: null !== r && void 0 !== r ? r : t.colors.neutral[0]
                        },
                        innerContainer: (n = {
                            padding: "32px 16px"
            ...
            var r = n(52322),
                ...
                _ = function(t) {
                    ...
                    return (0, r.jsxs)(a.Flex, {
                        onClick: function() {
                            (0, o.pr)({
                                action: "".concat((0, o.PO)(n.toLowerCase(), " ", "_"), "_card_clicked"),
                                category: c.E0.HOME
                            }), window.open("".concat(window.location.origin).concat(s), "_blank")
                        },
                        className: u.card,
                ...
                g = [{
                    ...
                    content: "At amber, we offer seamless booking process and a robust sales support.",
                    src: {
                        desktop: "".concat(d().app.image_static_assets_url, "/images/home_parter_with_us.png?auto=format&q=10"),
                        mobile: "".concat(d().app.image_static_assets_url, "/images/home_mobile_partner_with_us.png?auto=format&q=10")
                    },
                    redirectTo: "/partner",
                    ...
                    src: {
                        desktop: "".concat(d().app.image_static_assets_url, "/images/home_list_with_us.png?auto=format&q=10"),
                        mobile: "".concat(d().app.image_static_assets_url, "/images/home_mobile_list_with_us.png?auto=format&q=10")
                    },
                    redirectTo: "/list",
        ...
        70016: function(t, e, n) {
            ...
            var r = n(8388),
                ...
                l = 1441,
                _ = "".concat(a().app.image_static_assets_url, "/images/wechat-qr.png?auto=format&q=10"),
